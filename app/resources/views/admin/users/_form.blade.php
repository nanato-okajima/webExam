    ...
    <form action="{{ $route }}" method="POST">
      ...
      <div class="form-group">
        ...
        <div class="custom-control custom-radio custom-control-inline">
          <input class="custom-control-input" type="radio" id="man" name="gender" value="1" {{ $user->gender === 1 ? 'checked': ''}}>
          <label class="custom-control-label" for="man">男</label>
        </div>
        <div class="custom-control custom-radio custom-control-inline">
          <input class="custom-control-input" type="radio" id="woman" name="gender" value="2" {{ $user->gender === 2  ? 'checked': ''}}>
